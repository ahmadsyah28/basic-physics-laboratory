...
<div class="bg-white rounded-lg shadow-lg p-6">
    ...
    <div class="flex items-center mb-6">
        ...
        <div>
            ...
            <p class="text-gray-600 mt-1">Buat artikel atau berita baru</p>
        </div>
    </div>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div>
                    ...
                    <textarea id="deskripsi"
                              ...
                              placeholder="Tulis konten artikel...">{{ old('deskripsi') }}</textarea>
                    @error('deskripsi')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="datetime-local"
                           id="tanggal_acara"
                           name="tanggal_acara"
                           value="{{ old('tanggal_acara', now()->format('Y-m-d\TH:i')) }}"
